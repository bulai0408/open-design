...
export const zhTW: Dict = {
  ...
  'settings.skillsSideFiles': '技能附加檔案',
  'settings.skillsSideFilesDrop': '將檔案拖放到此處，或選擇檔案',
  'settings.skillsSideFilesChooseFolder': '選擇資料夾',
  'settings.skillsSideFilesHint': '新增應與 SKILL.md 放在一起的參考資料、腳本、資源或範例。',
  'settings.skillsSideFilesReading': '正在讀取所選檔案…',
  'settings.skillsSideFilesReadError': '無法讀取所選檔案。',
  'settings.skillsSideFilesRemove': '移除 {path}',
