...
export const en: Dict = {
  ...
  'pluginsView.uninstallAlreadyMissing': '{title} is no longer installed.',
  'pluginsView.uninstallCleanupIncomplete': 'Uninstalled {title}, but cleanup was incomplete.',
  'pluginsView.uninstallConfirmAria': 'Uninstall {title}',
  'pluginsView.uninstallConfirmBody': 'This removes the installed plugin from Open Design and deletes its local staged copy. Projects and snapshots that already used this plugin are kept.',
  'pluginsView.uninstallConfirmCloseAria': 'Close uninstall confirmation',
  'pluginsView.uninstallConfirmTitle': 'Uninstall {title}',
  'pluginsView.uninstallConfirmWarning': 'Reinstall from the original source if you need to use this plugin again.',
  'pluginsView.uninstallFailedReachDaemon': 'Failed to uninstall {title}. Make sure the daemon is reachable.',
  'pluginsView.uninstallFailedWithMessage': 'Failed to uninstall {title}. {message}',
  'pluginsView.uninstalling': 'Uninstalling…',
  'pluginsView.uninstallPlugin': 'Uninstall plugin',
  ...
  'pluginCard.uninstallAria': 'Uninstall {title}',
  'pluginCard.uninstallTitle': 'Uninstall plugin',
