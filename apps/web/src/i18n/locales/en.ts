...
export const en: Dict = {
  ...
  'plugins.team.title': 'Private team marketplaces',
  'plugins.team.subtitle': 'Register private catalogs and authenticate their GitHub hosts through gh.',
  'plugins.team.privateCatalogUrl': 'Private catalog URL',
  'plugins.team.privateCatalogPlaceholder': 'https://raw.githubusercontent.com/org/private/main/open-design-marketplace.json',
  'plugins.team.defaultTrust': 'Default trust for private catalog',
  'plugins.team.addPrivateCatalog': 'Add private catalog',
  'plugins.team.adding': 'Adding...',
  'plugins.team.empty': 'No private catalogs configured yet. Add a raw open-design-marketplace.json URL to begin.',
  'plugins.team.catalogVersion': 'catalog v{version}',
  'plugins.team.catalogVersionUnknown': 'catalog version unknown',
  'plugins.team.pluginsCount': '{count} plugins',
  'plugins.team.checkingAuth': 'Checking auth...',
  'plugins.team.authUnavailable': 'Auth status unavailable',
  'plugins.team.authenticatedAs': 'Authenticated as {login}',
  'plugins.team.authenticatedFor': 'Authenticated for {host}',
  'plugins.team.ghNotInstalled': 'GitHub CLI not installed',
  'plugins.team.notAuthenticatedFor': 'Not authenticated for {host}',
  'plugins.team.authUnknown': 'Auth status unknown',
  'plugins.team.opening': 'Opening...',
  'plugins.team.authenticate': 'Authenticate',
