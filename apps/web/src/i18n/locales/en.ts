...
export const en: Dict = {
  ...
  'pluginsView.authChecking': 'Checking auth…',
  'pluginsView.authUnavailable': 'Auth status unavailable',
  'pluginsView.authenticatedAs': 'Authenticated as {login}',
  'pluginsView.authenticatedFor': 'Authenticated for {host}',
  'pluginsView.authGhMissing': 'GitHub CLI not installed',
  'pluginsView.authNotAuthenticated': 'Not authenticated for {host}',
  'pluginsView.authUnknown': 'Auth status unknown',
  'pluginsView.authOpening': 'Opening…',
  'pluginsView.authenticate': 'Authenticate',
