...
export const en: Dict = {
  ...
  'settings.skillsSideFiles': 'Side files',
  'settings.skillsSideFilesDrop': 'Drop files here or choose files',
  'settings.skillsSideFilesChooseFolder': 'Choose folder',
  'settings.skillsSideFilesHint': 'Add references, scripts, assets, or examples that should live next to SKILL.md.',
  'settings.skillsSideFilesReading': 'Reading selected files…',
  'settings.skillsSideFilesReadError': 'Could not read selected files.',
  'settings.skillsSideFilesRemove': 'Remove {path}',
