...
export const ja: Dict = {
  ...
  'settings.skillsSideFiles': 'サイドファイル',
  'settings.skillsSideFilesDrop': 'ここにファイルをドロップ、またはファイルを選択',
  'settings.skillsSideFilesChooseFolder': 'フォルダーを選択',
  'settings.skillsSideFilesHint': 'SKILL.md と同じ場所に置く参照資料、スクリプト、アセット、または例を追加します。',
  'settings.skillsSideFilesReading': '選択したファイルを読み込んでいます…',
  'settings.skillsSideFilesReadError': '選択したファイルを読み込めませんでした。',
  'settings.skillsSideFilesRemove': '{path} を削除',
