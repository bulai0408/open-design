...
export const de: Dict = {
  ...
  'settings.skillsSideFiles': 'Begleitdateien',
  'settings.skillsSideFilesDrop': 'Dateien hier ablegen oder Dateien auswählen',
  'settings.skillsSideFilesChooseFolder': 'Ordner auswählen',
  'settings.skillsSideFilesHint': 'Füge Referenzen, Skripte, Assets oder Beispiele hinzu, die neben SKILL.md liegen sollen.',
  'settings.skillsSideFilesReading': 'Ausgewählte Dateien werden gelesen…',
  'settings.skillsSideFilesReadError': 'Ausgewählte Dateien konnten nicht gelesen werden.',
  'settings.skillsSideFilesRemove': '{path} entfernen',
