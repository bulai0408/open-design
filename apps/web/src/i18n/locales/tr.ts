...
export const tr: Dict = {
  ...
  'settings.skillsSideFiles': 'Yan dosyalar',
  'settings.skillsSideFilesDrop': 'Dosyaları buraya bırakın veya dosya seçin',
  'settings.skillsSideFilesChooseFolder': 'Klasör seç',
  'settings.skillsSideFilesHint': 'SKILL.md yanında bulunması gereken referansları, betikleri, varlıkları veya örnekleri ekleyin.',
  'settings.skillsSideFilesReading': 'Seçilen dosyalar okunuyor…',
  'settings.skillsSideFilesReadError': 'Seçilen dosyalar okunamadı.',
  'settings.skillsSideFilesRemove': '{path} öğesini kaldır',
