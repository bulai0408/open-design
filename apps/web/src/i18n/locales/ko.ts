...
export const ko: Dict = {
  ...
  'settings.skillsSideFiles': '보조 파일',
  'settings.skillsSideFilesDrop': '여기에 파일을 드롭하거나 파일 선택',
  'settings.skillsSideFilesChooseFolder': '폴더 선택',
  'settings.skillsSideFilesHint': 'SKILL.md 옆에 둘 참고 자료, 스크립트, 에셋 또는 예시를 추가합니다.',
  'settings.skillsSideFilesReading': '선택한 파일을 읽는 중…',
  'settings.skillsSideFilesReadError': '선택한 파일을 읽을 수 없습니다.',
  'settings.skillsSideFilesRemove': '{path} 제거',
