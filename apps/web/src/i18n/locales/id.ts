...
export const id: Dict = {
  ...
  'settings.skillsSideFiles': 'File pendamping',
  'settings.skillsSideFilesDrop': 'Jatuhkan file di sini atau pilih file',
  'settings.skillsSideFilesChooseFolder': 'Pilih folder',
  'settings.skillsSideFilesHint': 'Tambahkan referensi, skrip, aset, atau contoh yang harus berada di samping SKILL.md.',
  'settings.skillsSideFilesReading': 'Membaca file yang dipilih…',
  'settings.skillsSideFilesReadError': 'Tidak dapat membaca file yang dipilih.',
  'settings.skillsSideFilesRemove': 'Hapus {path}',
