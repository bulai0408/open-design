...
export const ar: Dict = {
  ...
  'settings.skillsSideFiles': 'ملفات جانبية',
  'settings.skillsSideFilesDrop': 'أسقط الملفات هنا أو اختر ملفات',
  'settings.skillsSideFilesChooseFolder': 'اختر مجلدًا',
  'settings.skillsSideFilesHint': 'أضف المراجع أو السكربتات أو الأصول أو الأمثلة التي يجب أن توضع بجانب SKILL.md.',
  'settings.skillsSideFilesReading': 'جارٍ قراءة الملفات المحددة…',
  'settings.skillsSideFilesReadError': 'تعذرت قراءة الملفات المحددة.',
  'settings.skillsSideFilesRemove': 'إزالة {path}',
