...
export const fr: Dict = {
  ...
  'settings.skillsSideFiles': 'Fichiers annexes',
  'settings.skillsSideFilesDrop': 'Déposez des fichiers ici ou choisissez des fichiers',
  'settings.skillsSideFilesChooseFolder': 'Choisir un dossier',
  'settings.skillsSideFilesHint': 'Ajoutez les références, scripts, ressources ou exemples qui doivent rester à côté de SKILL.md.',
  'settings.skillsSideFilesReading': 'Lecture des fichiers sélectionnés…',
  'settings.skillsSideFilesReadError': 'Impossible de lire les fichiers sélectionnés.',
  'settings.skillsSideFilesRemove': 'Supprimer {path}',
