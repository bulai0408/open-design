...
export const hu: Dict = {
  ...
  'settings.skillsSideFiles': 'Kiegészítő fájlok',
  'settings.skillsSideFilesDrop': 'Húzz ide fájlokat, vagy válassz fájlokat',
  'settings.skillsSideFilesChooseFolder': 'Mappa kiválasztása',
  'settings.skillsSideFilesHint': 'Adj hozzá hivatkozásokat, szkripteket, asseteket vagy példákat, amelyeknek a SKILL.md mellett kell lenniük.',
  'settings.skillsSideFilesReading': 'Kijelölt fájlok olvasása…',
  'settings.skillsSideFilesReadError': 'Nem sikerült beolvasni a kijelölt fájlokat.',
  'settings.skillsSideFilesRemove': '{path} eltávolítása',
