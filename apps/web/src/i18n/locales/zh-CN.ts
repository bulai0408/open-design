...
export const zhCN: Dict = {
  ...
  'settings.skillsSideFiles': '技能附加文件',
  'settings.skillsSideFilesDrop': '拖放文件到此处，或选择文件',
  'settings.skillsSideFilesChooseFolder': '选择文件夹',
  'settings.skillsSideFilesHint': '添加应与 SKILL.md 放在一起的参考资料、脚本、资源或示例。',
  'settings.skillsSideFilesReading': '正在读取所选文件…',
  'settings.skillsSideFilesReadError': '无法读取所选文件。',
