...
export const zhCN: Dict = {
  ...
  'plugins.team.title': '私有团队 marketplace',
  'plugins.team.subtitle': '注册私有 catalog，并通过 gh 认证对应的 GitHub 主机。',
  'plugins.team.privateCatalogUrl': '私有 catalog URL',
  'plugins.team.privateCatalogPlaceholder': 'https://raw.githubusercontent.com/org/private/main/open-design-marketplace.json',
  'plugins.team.defaultTrust': '私有 catalog 的默认信任级别',
  'plugins.team.addPrivateCatalog': '添加私有 catalog',
  'plugins.team.adding': '添加中...',
  'plugins.team.empty': '还没有配置私有 catalog。添加一个 raw open-design-marketplace.json URL 即可开始。',
  'plugins.team.catalogVersion': 'catalog v{version}',
  'plugins.team.catalogVersionUnknown': 'catalog 版本未知',
  'plugins.team.pluginsCount': '{count} 个插件',
  'plugins.team.checkingAuth': '正在检查认证...',
  'plugins.team.authUnavailable': '认证状态不可用',
  'plugins.team.authenticatedAs': '已认证为 {login}',
  'plugins.team.authenticatedFor': '已认证 {host}',
  'plugins.team.ghNotInstalled': '未安装 GitHub CLI',
  'plugins.team.notAuthenticatedFor': '{host} 未认证',
  'plugins.team.authUnknown': '认证状态未知',
  'plugins.team.opening': '正在打开...',
  'plugins.team.authenticate': '认证',
