...
export const zhCN: Dict = {
  ...
  'pluginsView.authChecking': '正在检查认证…',
  'pluginsView.authUnavailable': '认证状态不可用',
  'pluginsView.authenticatedAs': '已认证为 {login}',
  'pluginsView.authenticatedFor': '已认证 {host}',
  'pluginsView.authGhMissing': '未安装 GitHub CLI',
  'pluginsView.authNotAuthenticated': '{host} 未认证',
  'pluginsView.authUnknown': '认证状态未知',
  'pluginsView.authOpening': '正在打开…',
  'pluginsView.authenticate': '认证',
