...
export const zhCN: Dict = {
  ...
  'pluginsView.uninstallAlreadyMissing': '{title} 已不再安装。',
  'pluginsView.uninstallCleanupIncomplete': '已卸载 {title}，但清理未完成。',
  'pluginsView.uninstallConfirmAria': '卸载 {title}',
  'pluginsView.uninstallConfirmBody': '这会从 Open Design 中移除已安装插件，并删除本地暂存副本。已经使用过此插件的项目和快照会保留。',
  'pluginsView.uninstallConfirmCloseAria': '关闭卸载确认',
  'pluginsView.uninstallConfirmTitle': '卸载 {title}',
  'pluginsView.uninstallConfirmWarning': '如果之后还需要使用此插件，请从原始来源重新安装。',
  'pluginsView.uninstallFailedReachDaemon': '无法卸载 {title}。请确认 daemon 可访问。',
  'pluginsView.uninstallFailedWithMessage': '无法卸载 {title}。{message}',
  'pluginsView.uninstalling': '正在卸载…',
  'pluginsView.uninstallPlugin': '卸载插件',
  ...
  'pluginCard.uninstallAria': '卸载 {title}',
  'pluginCard.uninstallTitle': '卸载插件',
