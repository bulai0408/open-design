...
export const fa: Dict = {
  ...
  'settings.skillsSideFiles': 'فایل‌های جانبی',
  'settings.skillsSideFilesDrop': 'فایل‌ها را اینجا رها کنید یا فایل انتخاب کنید',
  'settings.skillsSideFilesChooseFolder': 'انتخاب پوشه',
  'settings.skillsSideFilesHint': 'منابع، اسکریپت‌ها، دارایی‌ها یا نمونه‌هایی را اضافه کنید که باید کنار SKILL.md قرار بگیرند.',
  'settings.skillsSideFilesReading': 'در حال خواندن فایل‌های انتخاب‌شده…',
  'settings.skillsSideFilesReadError': 'خواندن فایل‌های انتخاب‌شده ممکن نشد.',
  'settings.skillsSideFilesRemove': 'حذف {path}',
