...
export const esES: Dict = {
  ...
  'settings.skillsSideFiles': 'Archivos auxiliares',
  'settings.skillsSideFilesDrop': 'Suelta archivos aquí o elige archivos',
  'settings.skillsSideFilesChooseFolder': 'Elegir carpeta',
  'settings.skillsSideFilesHint': 'Añade referencias, scripts, recursos o ejemplos que deban vivir junto a SKILL.md.',
  'settings.skillsSideFilesReading': 'Leyendo archivos seleccionados…',
  'settings.skillsSideFilesReadError': 'No se pudieron leer los archivos seleccionados.',
  'settings.skillsSideFilesRemove': 'Eliminar {path}',
