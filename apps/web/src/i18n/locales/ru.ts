...
export const ru: Dict = {
  ...
  'settings.skillsSideFiles': 'Дополнительные файлы',
  'settings.skillsSideFilesDrop': 'Перетащите файлы сюда или выберите файлы',
  'settings.skillsSideFilesChooseFolder': 'Выбрать папку',
  'settings.skillsSideFilesHint': 'Добавьте справочные материалы, сценарии, ресурсы или примеры, которые должны находиться рядом с SKILL.md.',
  'settings.skillsSideFilesReading': 'Чтение выбранных файлов…',
  'settings.skillsSideFilesReadError': 'Не удалось прочитать выбранные файлы.',
  'settings.skillsSideFilesRemove': 'Удалить {path}',
