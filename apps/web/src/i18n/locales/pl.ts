...
export const pl: Dict = {
  ...
  'settings.skillsSideFiles': 'Pliki pomocnicze',
  'settings.skillsSideFilesDrop': 'Upuść pliki tutaj lub wybierz pliki',
  'settings.skillsSideFilesChooseFolder': 'Wybierz folder',
  'settings.skillsSideFilesHint': 'Dodaj odniesienia, skrypty, zasoby lub przykłady, które mają znajdować się obok SKILL.md.',
  'settings.skillsSideFilesReading': 'Odczytywanie wybranych plików…',
  'settings.skillsSideFilesReadError': 'Nie udało się odczytać wybranych plików.',
  'settings.skillsSideFilesRemove': 'Usuń {path}',
