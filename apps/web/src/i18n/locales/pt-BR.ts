...
export const ptBR: Dict = {
  ...
  'settings.skillsSideFiles': 'Arquivos auxiliares',
  'settings.skillsSideFilesDrop': 'Solte arquivos aqui ou escolha arquivos',
  'settings.skillsSideFilesChooseFolder': 'Escolher pasta',
  'settings.skillsSideFilesHint': 'Adicione referências, scripts, assets ou exemplos que devem ficar ao lado de SKILL.md.',
  'settings.skillsSideFilesReading': 'Lendo arquivos selecionados…',
  'settings.skillsSideFilesReadError': 'Não foi possível ler os arquivos selecionados.',
  'settings.skillsSideFilesRemove': 'Remover {path}',
