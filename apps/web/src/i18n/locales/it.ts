...
export const it: Dict = {
  ...
  'settings.skillsSideFiles': 'File di supporto',
  'settings.skillsSideFilesDrop': 'Trascina qui i file o scegli file',
  'settings.skillsSideFilesChooseFolder': 'Scegli cartella',
  'settings.skillsSideFilesHint': 'Aggiungi riferimenti, script, asset o esempi che devono stare accanto a SKILL.md.',
  'settings.skillsSideFilesReading': 'Lettura dei file selezionati…',
  'settings.skillsSideFilesReadError': 'Impossibile leggere i file selezionati.',
  'settings.skillsSideFilesRemove': 'Rimuovi {path}',
