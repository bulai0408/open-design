...
export const uk: Dict = {
  ...
  'settings.skillsSideFiles': 'Додаткові файли',
  'settings.skillsSideFilesDrop': 'Перетягніть файли сюди або виберіть файли',
  'settings.skillsSideFilesChooseFolder': 'Вибрати теку',
  'settings.skillsSideFilesHint': 'Додайте довідкові матеріали, скрипти, ресурси або приклади, які мають бути поруч із SKILL.md.',
  'settings.skillsSideFilesReading': 'Читання вибраних файлів…',
  'settings.skillsSideFilesReadError': 'Не вдалося прочитати вибрані файли.',
  'settings.skillsSideFilesRemove': 'Видалити {path}',
