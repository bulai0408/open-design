...
describe('FileViewer SVG artifacts', () => {
  ...
  it('keeps a URL-loaded preview iframe alive while the viewer unmounts and remounts', () => {
    ...
    expect(firstFrame.getAttribute('src')).toBe('/api/projects/project-1/raw/page.html?v=1710000000&r=0&odPreviewNav=1&odPreviewBridge=scroll&odPreviewBridge=selection');
    ...
    expect(parkedFrame?.getAttribute('src')).toBe('/api/projects/project-1/raw/page.html?v=1710000000&r=0&odPreviewNav=1&odPreviewBridge=scroll&odPreviewBridge=selection');
  ...
  it('URL-loads a plain HTML preview iframe instead of inlining via srcDoc', () => {
    ...
    expect(markup).toContain('src="/api/projects/project-1/raw/page.html?v=1710000000&amp;r=0&amp;odPreviewNav=1&amp;odPreviewBridge=scroll&amp;odPreviewBridge=selection"');
  ...
  it('reloads a URL-loaded HTML preview with a new cache key without replacing the iframe', () => {
    ...
    expect(frame.getAttribute('src')).toBe('/api/projects/project-1/raw/page.html?v=1710000000&r=0&odPreviewNav=1&odPreviewBridge=scroll&odPreviewBridge=selection');
    ...
    expect(reloadedFrame.getAttribute('src')).toBe('/api/projects/project-1/raw/page.html?v=1710000000&r=1&odPreviewNav=1&odPreviewBridge=scroll&odPreviewBridge=selection');
  });
  ...
  it('uses the next file URL immediately when switching URL-loaded HTML previews', () => {
    ...
    expect(initialFrame?.getAttribute('src')).toBe('/api/projects/project-1/raw/first.html?v=1710000000&r=0&odPreviewNav=1&odPreviewBridge=scroll&odPreviewBridge=selection');
    ...
    expect(observedCommittedSrcs[observationsBeforeSwitch]).toBe(
      '/api/projects/project-1/raw/second.html?v=1710000000&r=0&odPreviewNav=1&odPreviewBridge=scroll&odPreviewBridge=selection',
    );
    expect(nextFrame?.getAttribute('src')).toBe('/api/projects/project-1/raw/second.html?v=1710000000&r=0&odPreviewNav=1&odPreviewBridge=scroll&odPreviewBridge=selection');
  });
