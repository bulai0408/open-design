...
describe('FileViewer SVG artifacts', () => {
  ...
  it('keeps a URL-loaded preview iframe alive while the viewer unmounts and remounts', () => {
    ...
    expect(firstFrame.getAttribute('src')).toBe('/api/projects/project-1/raw/page.html?v=1710000000&r=0&odPreviewNav=1');
    ...
    expect(parkedFrame?.getAttribute('src')).toBe('/api/projects/project-1/raw/page.html?v=1710000000&r=0&odPreviewNav=1');
  ...
  it('uses the next file URL immediately when switching URL-loaded HTML previews', () => {
    ...
    expect(getFrame()?.getAttribute('src')).toBe('/api/projects/project-1/raw/first.html?v=1710000000&r=0&odPreviewNav=1');
